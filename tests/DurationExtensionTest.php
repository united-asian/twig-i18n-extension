...
class DurationExtensionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function intervalData()
    {
        return array(
            ...
            array('2015-01-02', '2015-02-02', 32, 0, 1, 1),
            array('2015-01-15', '2015-02-15', 32, 0, 1, 1),
            array('2015-01-28', '2015-02-28', 32, 0, 1, 1),
            array('2016-01-28', '2016-02-28', 32, 0, 1, 1),
            array('2016-01-28', '2016-02-29', 33, 0, 1, 2),
            array('2016-01-29', '2016-02-29', 32, 0, 1, 1),
            array('2016-01-30', '2016-02-29', 31, 0, 1, 0),
            array('2016-01-31', '2016-02-29', 30, 0, 0, 30),
            ...
            array('2009-03-01', '2009-03-31', 31, 0, 1, 0),
            array('2015-03-01', '2016-02-28', 365, 0, 11, 28),
            array('2015-03-01', '2016-02-29', 366, 1, 0, 0),
            array('2016-02-01', '2017-01-31', 366, 1, 0, 0),
            array('2016-03-01', '2017-02-28', 365, 1, 0, 0),
            array('2015-01-01', '2015-02-01', 32, 0, 1, 1),
        );
    }
    ...
    public function intervalDataMonths()
    {
        return array(
            ...
            array('2009-03-01', '2009-03-31', 'Y-M', 1),
            array('2015-03-01', '2016-02-28', 'Y-M', 12),
    ...
    public function dataEn()
    {
        return array(
            ...
            array('2016-2-28', '2016-3-1', 'H-I', '72h 0m'),
            array('2015-2-28', '2015-3-1', 'H-I', '48h 0m'),
            array('2016-01-01 02:00:00', '2016-01-01 05:00:00', 'H-I', '3h 0m'),
            array('2016-01-01 02:00:00', '2016-01-01 05:25:00', 'H-I', '3h 25m'),
            array('2016-01-01 02:00:00', '2016-01-01 05:32:00', 'H-I', '3h 32m'),

            // showing hours and seconds
            array('2016-01-01 02:00:00', '2016-01-01 05:00:00', 'H-S', '3h 0s'),
            array('2016-01-01 02:00:00', '2016-01-01 05:25:00', 'H-S', '3h 1500s'),
            array('2016-01-01 02:00:00', '2016-01-01 05:32:00', 'H-S', '3h 1920s'),

            // showing hours, minutes and seconds
            array('2016-2-28 00:00:00', '2016-3-1 5:25:25', 'H-I-S', '53h 25m 25s'),
            array('2015-2-28 2:00:00', '2015-3-1 3:15:59', 'H-I-S', '25h 15m 59s'),
            array('2016-01-01 02:00:00', '2016-01-01 05:00:00', 'H-I-S', '3h 0m 0s'),
            array('2016-01-01 02:00:00', '2016-01-01 05:25:10', 'H-I-S', '3h 25m 10s'),
            array('2016-01-01 02:00:00', '2016-01-01 05:32:42', 'H-I-S', '3h 32m 42s'),

            // showing years and seconds
            array('2010-01-01', '2011-01-01', 'Y-S', '1y 86400s'),
            array('2014-05-01', '2015-04-30', 'Y-S', '1y 0s'),
            array('2010-01-01 2:00:00', '2012-1-1 2:00:55', 'Y-S', '2y 55s'),

            // showing years and minutes
            array('2010-01-01', '2011-01-01', 'Y-I', '1y 1440m'),
            array('2014-05-01', '2015-04-30', 'Y-I', '1y 0m'),
            array('2010-01-01 2:00:00', '2012-1-1 2:02:00', 'Y-I', '2y 2m'),

            // showing years and hours
            array('2010-01-01', '2011-01-01', 'Y-H', '1y 24h'),
            array('2014-05-01', '2015-04-30', 'Y-H', '1y 0h'),
            array('2010-01-01 2:00:00', '2012-1-1 5:02:00', 'Y-H', '2y 3h'),

            // showing years, hours, minutes and seconds
            array('2010-01-01 00:25:00', '2011-01-01 1:26:20', 'Y-H-I-S', '1y 1h 1m 20s'),
            array('2014-05-01', '2015-04-30', 'Y-H-I-S', '1y 0h 0m 0s'),
            array('2010-01-01 2:00:00', '2012-1-1 5:02:59', 'Y-H-I-S', '2y 3h 2m 59s'),

            // showing years, hours and seconds
            array('2011-5-6 12:15:00', '2015-12-8 02:05:30', 'Y-H-S', '4y 44h 3030s'),
            array('2010-01-01 00:25:00', '2011-01-01 1:26:20', 'Y-H-S', '1y 1h 80s'),
            array('2014-05-01', '2015-04-30', 'Y-H-S', '1y 0h 0s'),
            array('2010-01-01 2:00:00', '2012-1-1 5:02:59', 'Y-H-S', '2y 3h 179s'),

            // showing months and seconds
            array('2011-5-6 12:15:00', '2015-12-8 02:05:30', 'M-S', '55m 136230s'),
            array('2010-01-01', '2010-02-05', 'M-S', '1m 432000s'),
            array('2010-01-01', '2010-01-31', 'M-S', '1m 0s'),

            // showing days and seconds
            array('2011-5-6 12:15:00', '2015-12-8 02:05:30', 'D-S', '1676d 49830s'),
            array('2010-01-01', '2010-12-31', 'D-S', '365d 0s'),
            array('2010-01-01 00:00:00', '2011-01-01 00:01:20', 'D-S', '365d 80s'),

            // showing months, days and seconds
            array('2011-5-6 12:15:00', '2015-12-8 02:05:30', 'M-D-S', '55m 1d 49830s'),
            array('2010-01-01 00:00:00', '2011-01-01 00:01:20', 'M-D-S', '12m 0d 80s'),
            array('2010-01-01 00:00:00', '2011-01-02 00:01:20', 'M-D-S', '12m 1d 80s'),
           ...
           // special cases
            ...
            array('2010-02-01', '2010-02-28', 'M-D', '1m 0d'),
            array('2010-02-01', '2010-02-28', 'M', '1m'),
            array('2016-02-01', '2016-02-29', 'M-D', '1m 0d'),
